...
describe('xml', function() {
    describe('removeNamespaces', function() {
        it('test simple', function() {
            ...
            var s = '';
            s += '<root xmlns:h="http://www.w3.org/TR/html4/" xmlns:f="https://www.w3schools.com/furniture">';
            s +=    '<h:table>';
            s +=        '<h:tr>';
            s +=            '<h:td>Apples</h:td>';
            s +=            '<h:td>Bananas</h:td>';
            ...
            var r = '';
            r += '<root h="http://www.w3.org/TR/html4/" f="https://www.w3schools.com/furniture">';
            r +=    '<table>';
            r +=        '<tr>';
            r +=            '<td>Apples</td>';
            r +=            '<td>Bananas</td>';
